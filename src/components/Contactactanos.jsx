        ...
        <div className="grid grid-cols-3 gap-2.5 mb-2.5">
          {[
            ...
            >
              ...
              <p className="text-blue-900 font-bold text-[11px] mb-0.5">
                {label}
              </p>
          ...
          <div className="flex flex-col gap-1.5 flex-1 text-left min-w-0">
            {[
              ...
              <div key={day} className="flex items-center gap-2">
                <span className="text-slate-600 text-[11px] font-medium text-right w-24 shrink-0">
                  {day}
                </span>
                <span className="w-px h-3.5 bg-blue-300 shrink-0" />
                <span className="text-blue-900 text-[11px] font-bold whitespace-nowrap">
                  {hours}
                </span>
              </div>
            ))}
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <div className="bg-[#E7ECEF] rounded-2xl p-3.5 border border-slate-200 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-blue-900 text-[11px] font-semibold mb-0.5">
                Calle XXX # 234 - 1231 Sur
              </p>
